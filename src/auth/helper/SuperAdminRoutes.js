  ...
  <div className="waveWrapperInner bgBottom">
    <div className="wave waveBottom" style={{backgroundImage: 'url("http://front-end-noobs.com/jecko/img/wave-bot.png")'}} />
      ...
      >
        ...
        <ListItemButton onClick={handleEventDrawerToggle}>
        <ListItemIcon>
          <TodayIcon />
        </ListItemIcon>
        <ListItemText primary="Event" />
        {openListToggle ? <ExpandLess /> : <ExpandMore />}
      </ListItemButton>
      <Collapse in={openListToggle} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <ListItemButton sx={{ pl: 4 }} onClick={handleDrawerListClick("/admin/event")}>
            <ListItemIcon>
              <AddBoxIcon />
            </ListItemIcon>
            <ListItemText primary="Create Event" />
          </ListItemButton>
          <ListItemButton sx={{ pl: 4 }} onClick={handleDrawerListClick("/admin/eventList")}>
            <ListItemIcon>
              <ViewListIcon />
            </ListItemIcon>
